...
import fr.cnp.apm.backoffice.repository.LabelValueRepository;
...
/**
 * Test class for the LabelValueResource REST controller.
 *
 * @see LabelValueResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = ApmBackofficeApp.class)
public class LabelValueResourceIntTest {
