...
import fr.cnp.apm.backoffice.repository.LabelRepository;
...
import static fr.cnp.apm.backoffice.web.rest.TestUtil.createFormattingConversionService;
...
public class LabelResourceIntTest {
    ...
    public void createLabel() throws Exception {
        ...
        assertThat(testLabel.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testLabel.getUpdateDate()).isEqualTo(DEFAULT_UPDATE_DATE);
    }
    ...
    public void updateLabel() throws Exception {
        ...
        assertThat(testLabel.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testLabel.getUpdateDate()).isEqualTo(UPDATED_UPDATE_DATE);
    }
