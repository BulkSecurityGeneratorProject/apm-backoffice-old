...
import fr.cnp.apm.backoffice.config.audit.AuditEventConverter;
import fr.cnp.apm.backoffice.domain.PersistentAuditEvent;
...
import static fr.cnp.apm.backoffice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
